...
public class AvroConsumer {
    ...
    public void readFromTopic(Properties envProps, String consumerGroupName) {

//Set properties for the consumer
        Properties consumerProps = new Properties();

        consumerProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, envProps.getProperty("KafkaIP"));
        ...
        consumerProps.put(KafkaAvroDeserializerConfig.SCHEMA_REGISTRY_URL_CONFIG,envProps.getProperty("KafkaSchemaRegistry"));


        KafkaConsumer<String, GenericRecord> consumer = new KafkaConsumer<>(consumerProps);
        consumer.subscribe(Collections.singleton(envProps.getProperty("KafkaTopic")));
